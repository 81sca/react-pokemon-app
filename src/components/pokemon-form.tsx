...
const PokemonForm: FunctionComponent<Props> = ({pokemon, isEditForm}) => {
  ...
  const isAddForm = () => {
    ...
    // validation du champ Image
		// picture doit commencer par https://assets.pokemon.com/assets/cms2/img/pokedex/detail/
    // et être au format .png
    if (isAddForm()) {
      const start:string = "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/";
      const end:string = ".png";

      if (!form.picture.value.startsWith(start) || !form.picture.value.endsWith(end) ) {
        const errorMsg:string = "Erreur sur l'URL de l'image";
